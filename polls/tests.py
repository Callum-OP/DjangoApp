...
"""
Things to consider in future below

We could also improve our application in other ways, adding tests along the way. 
For example, it is silly that Questions can be published on the site that have no Choices. 
So, our views could check for this, and exclude such Questions. 
Our tests would create a Question without Choices and then test that it is not published, 
